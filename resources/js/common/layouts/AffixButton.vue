...
import CurrencyAddButton from "../../main/views/settings/currency/AddButton.vue";
...
import LanguageAddButton from "../../main/views/settings/translations/langs/AddButton.vue";
